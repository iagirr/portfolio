...
const Contact = () => {
  ...
  return (
    ...
    >
        <div className='p8 text-left w-3/4'>
            <form action='https://getform.io/f/ef8883c9-fafb-4d2a-a620-cffeb52ccb74' method='POST'>
                ...
                <div className='w-full'>
                    <div className='flex flex-col my-2'>
                        ...
                        className='rounded-lg p-3 flex focus:outline-none
                    ...
                    <div className='flex flex-col'>
                        ...
                        className='rounded-lg p-8 flex focus:outline-none
                         dark:bg-gray-600 dark:text-white resize-none'>
                        </textarea>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-center'>
                    ...
                    rounded-md tracking-wider cursor-pointer hover:scale-105 duration-300 text-2xl'>
                        Send
                    </button>
                </div>
